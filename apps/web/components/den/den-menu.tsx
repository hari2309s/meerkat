...
function MutedBadge() {
    return (
        <span
            ...
            style={{ background: "rgba(120,120,120,0.14)", color: "var(--color-text-muted)" }}
        >
            On
        </span>
    );
        ...
        <div ref={menuRef} style={{ position: "relative" }}>
            <motion.button
                ...
                style={{
                    ...
                    background: menuOpen ? "var(--color-nav-item-hover-bg)" : "transparent",
                ...
                {menuOpen && (
                    <motion.div
                        ...
                        style={{
                            ...
                            boxShadow: "0 14px 44px rgba(0,0,0,0.22), 0 1px 0 rgba(255,255,255,0.08) inset",
