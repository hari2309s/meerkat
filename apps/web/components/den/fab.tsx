...
import { Mic, MessageSquare, ImageIcon, Camera, FileText, Plus } from "lucide-react";
...
const FAB_ACTIONS = [
    ...
    { key: "photo", icon: ImageIcon, label: "Photo from library", color: "#4a7fc1" },
...
function FabActionItem({
    ...
    return (
        <motion.div
            ...
            transition={{ delay: index * 0.045, type: "spring", stiffness: 460, damping: 28 }}
        ...
        >
            <motion.span
                ...
                style={{
                    background: hovered ? "var(--color-bg-card)" : "var(--color-bg-dropdown)",
            ...
            >
                <motion.div
                    ...
                    style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.24) 0%, transparent 55%)" }}
                />
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Plus className="h-6 w-6" style={{ color: "var(--color-btn-default-text)" }} />
                </motion.div>
            </motion.button>
        </div>
    );
