    ...
    return (
        <ModalShell onClose={onClose}>
            <div className="flex items-center gap-3 mb-5">
                ...
                >
                    {muted ? (
                        ...
                        <BellOff className="h-4 w-4" style={{ color: "var(--color-text-secondary)" }} />
                    )}
                </div>
                <div>
            ...
            <div className="flex gap-2">
                ...
                <HoverButton variant="primary" onClick={handleConfirm} className="flex-1 py-2.5 text-sm">
                    {muted ? (
                        <><Bell className="h-3.5 w-3.5" />Unmute</>
                    ) : (
                        <><BellOff className="h-3.5 w-3.5" />Mute den</>
                    )}
                </HoverButton>
            </div>
        </ModalShell>
